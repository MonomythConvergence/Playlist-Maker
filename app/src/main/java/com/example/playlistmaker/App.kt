...
import com.example.playlistmaker.di.newPlaylistModule
...
class App : Application() {
    ...
    override fun onCreate() {
        ...
        startKoin {
            ...
            modules(settingsModule, searchModule, playerModule, libraryModule, newPlaylistModule,editPlaylistModule)
        }
